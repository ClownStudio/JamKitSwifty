//
//  CustomTabbarItemContentView.swift
//
...
class CustomTabbarItemContentView: BouncesTabBarItemContentView {
...
class CustomBouncesTabbarItemContentView: ESTabBarItemContentView {
